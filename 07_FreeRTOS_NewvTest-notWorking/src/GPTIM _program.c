...
void PWM_Angle(u8 Copy_u8Angle,u8 Copy_u8TimerType)
{
	...
	if(Copy_u8TimerType == PWMTIM3)
	{
		switch (Copy_u8Angle)
		{
		case 0:  TIM3->TCCR4 = 0; break;
		case 20:  TIM3->TCCR4 = 20; break;
		case 40:  TIM3->TCCR4 = 40; break;
		case 60:  TIM3->TCCR4 = 60; break;
		case 80:  TIM3->TCCR4 = 80; break;
		case 100:  TIM3->TCCR4 = 100; break;
		case 120:  TIM3->TCCR4 = 120; break;
		case 140:  TIM3->TCCR4 = 140; break;
		case 160:  TIM3->TCCR4 = 160; break;
		case 180:  TIM3->TCCR4 = 180; break;
		case 200:  TIM3->TCCR4 = 200; break;
		case 220:  TIM3->TCCR4 = 220; break;
		case 240:  TIM3->TCCR4 = 240; break;
