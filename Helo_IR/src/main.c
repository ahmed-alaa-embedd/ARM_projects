...
void voidPlay(void)
{
	switch (u8Data)
	{
		case 71: MGPIO_VidSetPinValue(GPIOA,1,HIGH); break;
		case 70: MGPIO_VidSetPinValue(GPIOA,1,LOW);  break;
		case 69: MGPIO_VidSetPinValue(GPIOA,2,HIGH); break;
		case 67: MGPIO_VidSetPinValue(GPIOA,2,LOW);  break;
	}
}
